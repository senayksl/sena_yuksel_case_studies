    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <div style={{ position: "relative", width: "95vh", height: "17px" }}>

                        {props.modelList.map((model)=>
                        <FormGroup>
                            <FormControlLabel  control={<Checkbox style={{color:"#2a59fe"}} defaultChecked={false}  onClick={(e)=> {
                                if (e.target.checked===true){
                                    props.setSelectedModelList(oldArray => [...oldArray, e.target.value]);
                                    // props.selectedBrandList.push(e.target.value)
                                }else if (e.target.checked===false){
                                    props.setSelectedModelList((current) =>
                                        current.filter((mdl) => mdl !== e.target.value)
                                    );
                                    props.selectedModelList.pop(e.target.value)
                                }
